...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/xingxm/Datasets',
...
parser.add_argument('--sig', type=str, default="0.8,0.914,1.03,1.14,1.26,1.37,1.48,1.6",
...
parser.add_argument('--lambda_1', type=str, default="1.8,1.8",
                    help='one eigenvalue of anisotropic Gaussian blurs')
parser.add_argument('--lambda_2', type=str, default="0.5,1.0",
                    help='another eigenvalue of anisotropic Gaussian blurs')
parser.add_argument('--theta', type=str, default="0,15",
                    help='rotation angle of anisotropic Gaussian blurs [0, 180]')
parser.add_argument('--HRLR', default=False,
                    help='provide HR-LR pairs')
...
# Loss specifications
parser.add_argument('--weight_kl', type=float, default=4000,
                    help='weight of kernel_loss')
parser.add_argument('--weight_cl', type=float, default=1,
                    help='weight of constract_loss')
parser.add_argument('--weight_srl', type=float, default=200,
                    help='weight of sr_loss')
